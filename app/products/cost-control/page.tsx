...
import RevenueImg from "@/public/images/ProductPage/CostControl.webp"
import PrepForecastImg from "@/public/images/AgentGraphs/PrepForecastAgent.webp"
import WasteControlImg from "@/public/images/AgentGraphs/WasteControlAgents.webp"
import LaborOptimizationImg from "@/public/images/AgentGraphs/WorkforceManagement.webp"
import MenuEngineeringImg from "@/public/images/AgentGraphs/MenuEngineeringAgent.webp"
import MarketingSpendImg from "@/public/images/AgentGraphs/MarketingSpendDoorDash.webp"
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Cost Control Agents for Restaurants | Kutlerri",
  description:
  ...
  openGraph: {
    title: "Control Restaurant Costs With AI Agents | Kutlerri",
    description:
      "Waste reduction, prep forecasting, labor optimization & menu margin analysis — Kutlerri agents deliver daily cost actions, not spreadsheets.",
...
const agentsData: Agent[] = [
  {
    ...
    imageAlt: "Kutlerri waste control agent showing food waste reduction dashboard",
    cards: [
      {
...

  {
    ...
    imageAlt: "Prep forecast chart reducing over-production in restaurant kitchen",
    cards: [
      {
...

  {
    ...
    imageAlt: "Kutlerri labor cost optimization agent with demand-aligned staffing view",
    cards: [
      {
...

  {
    ...
    imageAlt: "Menu margin analysis table generated by Kutlerri AI agent",
    cards: [
      {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Cost Control Agents", item: "https://kutlerri.ai/products/cost-control" },
            ],
          }),
        }}
      />
