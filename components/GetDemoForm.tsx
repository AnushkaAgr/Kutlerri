    ...
    if (isSuccess) {
        return (
            ...
            >
                ...
                <h3 className="text-2xl font-bold text-[#300B60] mb-2 font-avant">Request Received!</h3>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-[#300B60] font-medium">First Name</FormLabel>
                                    <FormControl>
                                        <Input
                                            placeholder="First Name"
                                            className="bg-white/50 border-purple-100 focus:border-[#7C5CFA] focus:ring-[#7C5CFA] rounded-[12px] h-12"
                                            {...field}
                                        />
                                    </FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-[#300B60] font-medium">Last Name</FormLabel>
                                    <FormControl>
                                        <Input
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-[#300B60] font-medium">Work Email</FormLabel>
                                <FormControl>
                                    <Input
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-[#300B60] font-medium">Restaurant Name</FormLabel>
                                <FormControl>
                                    <Input
                                        placeholder=""
                                        className="bg-white/50 border-purple-100 focus:border-[#7C5CFA] focus:ring-[#7C5CFA] rounded-[12px] h-12"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-[#300B60] font-medium">No. of Locations</FormLabel>
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        <FormControl>
                                            <SelectTrigger className="bg-white/50 border-purple-100 focus:border-[#7C5CFA] rounded-[12px] h-12">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-[#300B60] font-medium">Point of Sales</FormLabel>
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        <FormControl>
                                            <SelectTrigger className="bg-white/50 border-purple-100 focus:border-[#7C5CFA] rounded-[12px] h-12">
                    ...
                    <p className="text-center text-xs text-[#2E312E]/50 px-4">
                        By clicking "Get My Demo", you agree to our terms of service and privacy policy.
