...
export const heroSlides = [
  ...
  },
  {
    ...
    rightContent: {
      ...
      paragraph2:
        "Kutlerri’s Cost Control Agents: Call out the biggest leaks and tell you what to do Monday morning.",
  ...
  {
    title:
      "If you’re paying 15–30% to grow, you better be damn sure it’s working",
    ...
    rightContent: {
      ...
      paragraph2:
        "KKutlerri’s Revenue Growth Agents: turn catering into a repeatable engine while quietly lifting margins with demand-led menus, executable upsells, and retention loops that keep customers coming back.",
